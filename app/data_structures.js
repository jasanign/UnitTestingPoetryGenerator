 ...
 * @returns {{}} wordCount object with unique words as keys and
 ...
 * in the given text
 * @param text the text string retrieved from the input text file
 * @returns {{}} wordFreq object in word : frequency manner
 */
 ...
 * @returns {{}} condWordCount object in the following manner:
 ...
 * of a unique word
 * @param text text the text string retrieved from the input text file
 * @returns {{}} condWordFreq object in the following manner:
 ...
 */
var checkWord = function(word, yourObj) {
    if (!(word in yourObj)) {
        yourObj[word] = 1;
    } else {
 ...
 * @returns  text read from the text file
 */
 ...
 * @returns  "empty" if the file has nothing but the whitespaces
 */
var checkEmptyFile = function(data){
